...
console.log(valueA >= valueB);
console.log(valueA <= valueB);
console.log(valueA == valueB); // == hanya menyocokkan nilai tidak melihat tipe data
console.log(valueA === valueB); // === mennyocokkan nilai dan tipe data
...
// NOT : logika yang akan membalikkan nilai boolean
console.log(!false);
console.log(!(valueA === valueB));
