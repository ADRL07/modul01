...
const gadgetList: string[] = ['Handphone', 'Laptop', 'TWS', 'Pen'];
...
// Cara merubah salah satu data array secara langsung
gadgetList[1] = 'Macbook';
console.log(gadgetList);
console.log(gadgetList[2]);
// Dari data array yang ada, coba rubah menjadi data string berbentuk barang
// PROCESS
...
// Array function
// array.legth : mengethui jumlah data pada array
...
// array.splice() : menghapus/menyisipkan/memperbaruhi data pada index tertentu
// 1. Menghapus data : array.splice(pilihIndex, JumlahYangDihapus)
let carBrands : string[] = ['Toyota', 'Honda', 'Nissan'];
console.log(carBrands);
carBrands.splice(1, 1);
console.log(carBrands);

// 2. Menyisipkan data : array.splice(pilihIndex, jumlahYangDihapus, newData1, newData2; ...)
carBrands.splice(1, 0, 'Subaru', 'Lexus');
console.log(carBrands);

// 3. Memperbaruhi data : array.splice(pilihIndex, 1, newData)
...
// arrayreverse(): membalikkan urutan data
carBrands.reverse();
console.log(carBrands);
...
const studentsB: string[] = ['Eric', 'Steven'];
// array.concat(dataArray1, dataArray2, ...);
const students: string[] = studentsA.concat(studentsB, 'Ruben', 'Sanadi');
console.log(students);

// Spread operator : menyalin data dari suatu array ke array yang baru dan menggabungkan dengan array lain
const studentsList: string[] = [...studentsA, ...studentsB, 'Ruben'];
